package com.sameer.arduinocontroller.ui.favourite;
...
import com.sameer.arduinocontroller.DatabaseHandler.DatabaseHandler;
import com.sameer.arduinocontroller.DatabaseHandler.Recipe;
import com.sameer.arduinocontroller.Login;
import com.sameer.arduinocontroller.Main;
import com.sameer.arduinocontroller.ModelWholeRoom;
import com.sameer.arduinocontroller.R;
import com.sameer.arduinocontroller.RoomItem;
...
public class FavouriteFragment extends Fragment {
    ...
    private CardView addRoom(int index, ModelWholeRoom modelWholeRoom)
    {
        ...
        cardView.setOnClickListener(v -> {
            if ("Hall RoomItem".equalsIgnoreCase(modelWholeRoom.roomName)) {
            ...
            else if ("Living RoomItem".equalsIgnoreCase(modelWholeRoom.roomName)) {
                Intent intent = new Intent(getContext(), RoomItem.class);
                intent.putExtra("image",modelWholeRoom.roomImage);
                RoomControl.roomNumber = index;
                startActivity(intent);
            }
            else if ("Bed RoomItem 1".equalsIgnoreCase(modelWholeRoom.roomName)) {
                Intent intent = new Intent(getContext(), RoomItem.class);
                intent.putExtra("image",modelWholeRoom.roomImage);
                RoomControl.roomNumber = index;
                startActivity(intent);
            ...
            else if ("Bed RoomItem 2".equalsIgnoreCase(modelWholeRoom.roomName)) {
                Intent intent = new Intent(getContext(), RoomItem.class);
                intent.putExtra("image",modelWholeRoom.roomImage);
                RoomControl.roomNumber = index;
                startActivity(intent);
            }
            else if ("Bath RoomItem 1".equalsIgnoreCase(modelWholeRoom.roomName)) {
                Intent intent = new Intent(getContext(), RoomItem.class);
                intent.putExtra("image",modelWholeRoom.roomImage);
                RoomControl.roomNumber = index;
                startActivity(intent);
            }
            else if ("Bath RoomItem 2".equalsIgnoreCase(modelWholeRoom.roomName)) {
                Intent intent = new Intent(getContext(), RoomItem.class);
                intent.putExtra("image",modelWholeRoom.roomImage);
                RoomControl.roomNumber = index;
                startActivity(intent);
