package com.smart_home.main_fragments.Rooms;
...
//    static  String IP = "192.168.1.130";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        homeViewModel =
                new ViewModelProvider(this).get(ui.Rooms.RoomsViewModel.class);
...
//        });
       ...
       /* hallRoom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), smart_home.Room.class);
        ...
        bathRoom2.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), smart_home.Room.class);
                ActivityOptions options = ActivityOptions
                        .makeSceneTransitionAnimation(getActivity(),
                                bathImage2, "robot");
