package com.smart_home.ui.Rooms;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
       ...
       /* hallRoom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), smart_home.RoomItem.class);
        ...
        bathRoom2.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), smart_home.RoomItem.class);
                ActivityOptions options = ActivityOptions
                        .makeSceneTransitionAnimation(getActivity(),
                                bathImage2, "robot");
