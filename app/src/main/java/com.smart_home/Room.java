...
//        });
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(
                ...
                (view, hourOfDay, minute) -> {
                    ...
                    if (!isMyServiceRunning(DeviceTimer1.class)) {
                        ...
                        Intent intent = new Intent(Room.this, DeviceTimer1.class);
                        ...
                        Intent intent = new Intent(Room.this, DeviceTimer2.class);
                        intent.putExtra("time", time);
                        intent.putExtra("status", status);
                        intent.putExtra("path", "Home 1/" + Login.userUid + "/" + roomName + "/device " + (++d) + "/status");
                        ...
                        Intent intent = new Intent(Room.this, DeviceTimer3.class);
                        intent.putExtra("time", time);
                        intent.putExtra("status", status);
                        intent.putExtra("path", "Home 1/" + Login.userUid + "/" + roomName + "/device " + (++d) + "/status");
                        ...
                        Intent intent = new Intent(Room.this, DeviceTimer4.class);
                        intent.putExtra("time", time);
                        intent.putExtra("status", status);
                        intent.putExtra("path", "Home 1/" + Login.userUid + "/" + roomName + "/device " + (++d) + "/status");
                        ...
                        Intent intent = new Intent(Room.this, DeviceTimer5.class);
                        intent.putExtra("time", time);
                        intent.putExtra("status", status);
                        intent.putExtra("path", "Home 1/" + Login.userUid + "/" + roomName + "/device " + (++d) + "/status");
    ...
    public void setTimer(View view) {
        ...
        AlertDialog alertDialog = new AlertDialog.Builder(Room.this)
                .setTitle("Set Timer")
                        ...
                        TimePickerDialog timePickerDialog = new TimePickerDialog(
                                ...
                                new TimePickerDialog.OnTimeSetListener() {
                                    ...
                                    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                                        ...
                                        if (RoomControl.roomNumber == 0) {
                                            Intent intent = new Intent(Room.this, TimerService.class);
                                            intent.putExtra("time", time);
                                        ...
                                        if (RoomControl.roomNumber == 1) {
                                            Intent intent = new Intent(Room.this, TimerService2.class);
                                            intent.putExtra("time", time);
                                            intent.putExtra("inst", m.turnOffInstructions);
                                            startService(intent);
                                        ...
                                        if (RoomControl.roomNumber == 2) {
                                            Intent intent = new Intent(Room.this, TimerService3.class);
                                            intent.putExtra("time", time);
                                            intent.putExtra("inst", m.turnOffInstructions);
                                            startService(intent);
                                        ...
                                        if (RoomControl.roomNumber == 3) {
                                            Intent intent = new Intent(Room.this, TimerService4.class);
                                            intent.putExtra("time", time);
                                            intent.putExtra("inst", m.turnOffInstructions);
                                            startService(intent);
                                        ...
                                        if (RoomControl.roomNumber == 4) {
                                            Intent intent = new Intent(Room.this, TimerService5.class);
                                            intent.putExtra("time", time);
                                            intent.putExtra("inst", m.turnOffInstructions);
                                            startService(intent);
                                        ...
                                        if (RoomControl.roomNumber == 5) {
                                            Intent intent = new Intent(Room.this, TimerService6.class);
                                            intent.putExtra("time", time);
                                            intent.putExtra("inst", m.turnOffInstructions);
                                            startService(intent);
        ...
        AlertDialog alertDialog = new AlertDialog.Builder(Room.this)
                ...
                .setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        stopService(new Intent(Room.this, serviceClass));
